...
const StatsCard = ({ data,handler }) => {
  ...
  return (
    ...
    //   />
    // </Card>
    <div className="shadow-[-7px_10px_12px_-1px_rgba(0,0,0,0.03)]  flex space-x-10 bg-white rounded-20   p-20 ">
      <div className="p-18 bg-red-100 flex items-center justify-center rounded-20">
        {data.icon}
      </div>
